Main.widgets = {
	...
	genericDialog1: ["wm.GenericDialog", {"desktopHeight":"61px","height":"69px","modal":false,"title":"This is a Generic Dialog","userPrompt":"Hello WaveyWeb"}, {}],
			...
			panel2: ["wm.MainContentPanel", {"height":"100%","horizontalAlign":"left","layoutKind":"left-to-right","verticalAlign":"top","width":"100%"}, {}, {
				tabLayers1: ["wm.TabLayers", {}, {}, {
					...
					layer2: ["wm.Layer", {"border":"1","borderColor":"#999999","caption":"Tab 2","horizontalAlign":"left","verticalAlign":"top"}, {}, {
						...
						pageContainer1: ["wm.PageContainer", {"deferLoad":true,"pageName":"Page2","subpageEventlist":{},"subpageMethodlist":{},"subpageProplist":{}}, {}]
					}],
						...
						hrdbLivePanel: ["wm.LivePanel", {"horizontalAlign":"left","verticalAlign":"top"}, {}, {
							...
							departmentDetailsPanel: ["wm.FancyPanel", {"fitToContentHeight":true,"height":"326px","title":"Details"}, {}, {
								departmentLiveForm1: ["wm.LiveForm", {"editorWidth":"90%","fitToContentHeight":true,"height":"294px","horizontalAlign":"center","readonly":true,"verticalAlign":"top"}, {"onSuccess":"departmentLiveVariable1"}, {
									...
									deptidEditor1: ["wm.Number", {"caption":"Deptid","captionSize":"140px","changeOnKey":true,"dataValue":0,"desktopHeight":"26px","emptyValue":"zero","formField":"deptid","height":"26px","readonly":true,"required":true,"width":"90%"}, {}],
									...
									budgetEditor1: ["wm.Number", {"caption":"Budget","captionSize":"140px","changeOnKey":true,"dataValue":0,"desktopHeight":"26px","emptyValue":"zero","formField":"budget","height":"26px","readonly":true,"width":"90%"}, {}],
									q1Editor1: ["wm.Number", {"caption":"Q1","captionSize":"140px","changeOnKey":true,"dataValue":0,"desktopHeight":"26px","emptyValue":"zero","formField":"q1","height":"26px","readonly":true,"width":"90%"}, {}],
									q2Editor1: ["wm.Number", {"caption":"Q2","captionSize":"140px","changeOnKey":true,"dataValue":0,"desktopHeight":"26px","emptyValue":"zero","formField":"q2","height":"26px","readonly":true,"width":"90%"}, {}],
									q3Editor1: ["wm.Number", {"caption":"Q3","captionSize":"140px","changeOnKey":true,"dataValue":0,"desktopHeight":"26px","emptyValue":"zero","formField":"q3","height":"26px","readonly":true,"width":"90%"}, {}],
									q4Editor1: ["wm.Number", {"caption":"Q4","captionSize":"140px","changeOnKey":true,"dataValue":0,"desktopHeight":"26px","emptyValue":"zero","formField":"q4","height":"26px","readonly":true,"width":"90%"}, {}],
									deptcodeEditor1: ["wm.Text", {"caption":"Deptcode","captionSize":"140px","changeOnKey":true,"dataValue":"","desktopHeight":"26px","emptyValue":"emptyString","formField":"deptcode","height":"26px","readonly":true,"width":"90%"}, {}],
									locationEditor1: ["wm.Text", {"caption":"Location","captionSize":"140px","changeOnKey":true,"dataValue":"","desktopHeight":"26px","emptyValue":"emptyString","formField":"location","height":"26px","readonly":true,"width":"90%"}, {}],
									tenantidEditor1: ["wm.Number", {"caption":"Tenantid","captionSize":"140px","changeOnKey":true,"dataValue":0,"desktopHeight":"26px","emptyValue":"zero","formField":"tenantid","height":"26px","readonly":true,"width":"90%"}, {}],
