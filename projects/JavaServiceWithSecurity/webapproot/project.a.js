...
wm.types = {
	"types": {
		...
		"com.wavemaker.runtime.service.RuntimeService": {
			"fields": {
				"internalRuntime": {
					"exclude": [],
					"fieldOrder": 0,
...
dojo.declare("JavaServiceWithSecurity", wm.Application, {
...
JavaServiceWithSecurity.extend({

	_end: 0
});
JavaServiceWithSecurity.prototype._css = '';
