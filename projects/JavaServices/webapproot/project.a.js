...
wm.types = {
	"types": {
		...
		"com.custpurchasedb.CustpurchaseDB": {
			"fields": {
				"dataServiceManager": {
					"exclude": [],
					"fieldOrder": 0,
		...
		"com.wavemaker.runtime.RuntimeAccess": {
			"fields": {
				"instance": {
					"exclude": [],
					"fieldOrder": 0,
...
dojo.declare("JavaServices", wm.Application, {
